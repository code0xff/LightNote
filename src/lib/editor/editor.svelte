<script lang="ts">
	...
	function download() {
		...
		const style = `<style>code{font-family:monospace;background-color:rgb(97,97,97,0.1);color:#616161;}pre{display:block;font-family:monospace;white-space:pre;background:rgb(97,97,97,0.1);color:#616161;margin:1em 0;padding:1rem;}pre>code{color:inherit;padding:0;background:none;}blockquote{padding-left:1rem;border-left:2px solid #616161;}</style>`;
